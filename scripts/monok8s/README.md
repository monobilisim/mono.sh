...
| [kubeadm-upgrade.sh](https://github.com/monobilisim/mono.sh/blob/main/kubernetes/kubeadm-upgrade.sh) | kubeadm cluster upgrade script |
| [rke2-upgrade.sh](https://github.com/monobilisim/mono.sh/blob/main/kubernetes/rke2-upgrade.sh) | RKE2 cluster upgrade script |
